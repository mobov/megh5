(function (global, factory) {
    ...
    (global = global || self, factory(global.Megh5UI = {}));
    ...
    ***************************************************************************** */
    ...
    const unit = '100vw / 100'; // interface screenSize {
    //   height: '100vh',
    //   width: '100vw'
    // }
    //
    ...
    function genPosX(styles = {}, val, float = false) {
      if (val !== undefined) {
        if (float) {
    ...
    function genPosY(styles = {}, val, float = false) {
      if (val !== undefined) {
        if (float) {
    ...
    let HApp = class HApp extends Vue {
      get styles() {
        const {
          height,
          width,
    ...
    let HButton = class HButton extends Vue {
      onClick(e) {}
    ...
    HButton$1.install = Vue => {
      Vue.component(HButton$1.name, HButton$1);
    };

    let HView = class HView extends Vue {
      get float() {
        return this.position !== 'relative';
      }
    ...
    let HFooter = class HFooter extends Vue {
      get viewTermsText() {
    ...
    let HPromoCode = class HPromoCode extends Vue {
      get viewLabel() {
    ...
    HPromoCode$1.install = Vue => {
      Vue.component(HPromoCode$1.name, HPromoCode$1);
    };

    let HText = class HText extends Vue {
      get viewText() {
        return getStrValue(this, this.text);
      }
